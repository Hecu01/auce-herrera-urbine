<div class="register3 not-display en-comun">
    ...
    <div class="mx-4">
        ...
        <div class="form-check mb-2 d-flex" >
            <div class="">
                <input class="form-check-input" type="radio" name="aspirante_tiene_hijos" id="si_tiene_hijos" value="1">
                <label class="form-check-label" for="si_tiene_hijos">
                    Si
                </label>
            </div>
            <div class="form-check mx-3">
                <input class="form-check-input" type="radio" name="aspirante_tiene_hijos" id="no_tiene_hijos"  value="0">
        ...
        <div class="form-check d-flex" >
            <div class="">
                <input class="form-check-input" type="radio" value="1" name="fam_a_cargo_aspirante" id="si_fam_a_cargo">
                <label class="form-check-label" for="si_fam_a_cargo">
                    Sí
                </label>
            </div>
            <div class="form-check mx-3">
                <input class="form-check-input" type="radio" value="0" name="fam_a_cargo_aspirante" id="no_fam_a_cargo" >
        ...
        <div class="my-3 mx-2">
            ...
            <div class="form-floating " >
                <select class="form-select" id="carrera_a_estudiar" name="carrera_elejida_aspirante"  aria-label="Floating label select example">
